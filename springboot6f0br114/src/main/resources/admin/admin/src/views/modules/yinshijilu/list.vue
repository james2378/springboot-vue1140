				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yinshijilu','饮食建议')" @click="yinshijianyiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
	...
	export default {
		...
		methods: {
			...
			yinshijianyiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				...
				this.$storage.set('crossTable','yinshijilu');
