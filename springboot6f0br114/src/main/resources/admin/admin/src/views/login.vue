<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","padding":"20px  400px 20px 0","alignItems":"center","background-attachment":"fixed","background":"url(http://codegen.caihongy.cn/20240123/d1ba7e0d26fa4d5399682bd916e837d6.png) no-repeat  20%  40%/ 400px auto,#f9fbfd","display":"flex","width":"100%","justifyContent":"flex-end"}'>
      <el-form :style='{"padding":"40px 20px","margin":"0","borderRadius":"8px","flexWrap":"wrap","background":"rgba(106, 171, 156)","display":"flex","width":"420px"}'>
        <div v-if="true" :style='{"padding":"40px 0","margin":"0 auto 20px auto","borderColor":"#fff","color":"#fff","textAlign":"center","borderWidth":"0 0 1px 0","width":"80%","lineHeight":"44px","fontSize":"28px","borderStyle":"solid"}' class="title-container">健康健身追踪系统登录</div>
