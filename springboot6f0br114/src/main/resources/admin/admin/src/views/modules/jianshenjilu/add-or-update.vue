	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="运动时长/小时" prop="yundongshizhang">
					<el-input-number v-model="ruleForm.yundongshizhang" placeholder="运动时长/小时" :readonly="ro.yundongshizhang"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="运动时长/小时" prop="yundongshizhang">
					<el-input v-model="ruleForm.yundongshizhang" placeholder="运动时长/小时" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="运动感受" prop="yundongganshou">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="运动感受"
					  v-model="ruleForm.yundongganshou" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.yundongganshou" label="运动感受" prop="yundongganshou">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yundongganshou}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				yundongshizhang: [
					{ required: true, message: '运动时长/小时不能为空', trigger: 'blur' },
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yundongganshou'){
							this.ruleForm.yundongganshou = obj[o];
							this.ro.yundongganshou = true;
							continue;
						}
						if(o=='jilushijian'){
