<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"width":"100%","padding":"4px 30px","borderColor":"#d8dce5","borderStyle":"solid","borderWidth":"0 0 1px","height":"34px"}'>
