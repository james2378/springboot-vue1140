...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="营养分析" prop="yingyangfenxi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="营养分析"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="饮食建议" prop="yinshijianyi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="饮食建议"
