...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="餐食来源" prop="canshilaiyuan">
            <el-select v-model="ruleForm.canshilaiyuan" placeholder="请选择餐食来源" :disabled=" false  ||ro.canshilaiyuan" multiple filterable>
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="饮食内容" prop="yinshineirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="饮食内容"
