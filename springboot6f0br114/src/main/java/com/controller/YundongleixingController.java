...
public class YundongleixingController {
    ...
    public R save(@RequestBody YundongleixingEntity yundongleixing, HttpServletRequest request){
        if(yundongleixingService.selectCount(new EntityWrapper<YundongleixingEntity>().eq("yundongleixing", yundongleixing.getYundongleixing()))>0) {
            return R.error("运动类型已存在");
        }
    ...
    public R update(@RequestBody YundongleixingEntity yundongleixing, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yundongleixing);
        if(yundongleixingService.selectCount(new EntityWrapper<YundongleixingEntity>().ne("id", yundongleixing.getId()).eq("yundongleixing", yundongleixing.getYundongleixing()))>0) {
            return R.error("运动类型已存在");
        }
